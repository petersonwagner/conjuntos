...
while [  $COUNTER -lt 100 ]; do
	...
	for i in 1 2 4 8;
	do
		echo "./gerador.py -n ${i}000 -x ${i}00 -b ${i}00 -s 0 -p 0 -k 1000 -e 10 -o testes/entrada_${i}k_$COUNTER.txt -r testes/saida_${i}k_$COUNTER.txt"
		./gerador.py -n ${i}000 -x ${i}00 -b ${i}00 -s 0 -p 0 -k 1000 -e 10 -o testes/entrada_${i}k_$COUNTER.txt -r testes/saida_${i}k_$COUNTER.txt;
	done;
